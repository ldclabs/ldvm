...
func (s *CBORService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	s.writeCBOR(ctx, w, http.StatusOK, res)
}

func (s *CBORService) writeCBOR(ctx context.Context, w http.ResponseWriter, code int, res *cborrpc.Response) {
