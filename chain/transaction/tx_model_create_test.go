...
func TestTxCreateModel(t *testing.T) {
	...
	assert.ErrorContains(itx.Apply(bctx, bs),
		"insufficient NativeLDC balance, expected 3707000, got 0")
	bs.CheckoutAccounts()
