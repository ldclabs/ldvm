...
func (tx *TxUpdateDataInfoByAuth) MarshalJSON() ([]byte, error) {
	...
	v := tx.ld.Copy()
	errp := erring.ErrPrefix("txn.TxUpdateDataInfoByAuth.MarshalJSON: ")
	if tx.input == nil {
...
func (tx *TxUpdateDataInfoByAuth) SyntacticVerify() error {
	var err error
	errp := erring.ErrPrefix("txn.TxUpdateDataInfoByAuth.SyntacticVerify: ")
...
func (tx *TxUpdateDataInfoByAuth) Apply(ctx ChainContext, cs ChainState) error {
	var err error
	errp := erring.ErrPrefix("txn.TxUpdateDataInfoByAuth.Apply: ")
