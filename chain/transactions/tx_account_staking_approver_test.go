...
func TestTxUpdateStakeApprover(t *testing.T) {
	...
	senderAcc.Add(constants.NativeToken, new(big.Int).SetUint64(constants.LDC*1002))
	...
	assert.Equal(constants.LDC-senderGas*(ctx.Price+100), senderAcc.Balance().Uint64())
